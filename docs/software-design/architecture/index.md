...
- [:fontawesome-solid-book-open: Command Query Separation](../design-patterns/command-query-separation.md)
- [:fontawesome-solid-book-open: Command Query Resposibility Segregation (CQRS)](../design-patterns/cqrs.md)
...
- [:fontawesome-solid-book-open: Architectural Decision Records](adr.md)
