...
[Practicalli dotfiles](https://practical.li/dotfiles) includes Debian Linux post install scripts which use DRA to install the latest versions of tools that are not part of the official Debian package repositories.

![DRA in action](https://github.com/devmatteini/dra/raw/main/assets/demo.gif){loading=lazy}
...
=== "Practicalli Script"
    ...
    A script to install DRA globally (`/usr/local/bin`) and generate shell (bash or zsh) completions.
