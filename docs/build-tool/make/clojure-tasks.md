# Makefile tasks for Clojure projects


## Create a Clojure project

Generate a new Clojure project using [seancorfield/deps-new]() and [Practicalli Project Templates](https://github.com/practicalli/project-templates).

- `service` generates a server-side web service
- `service-donut` as above, using [donut/system]() for service component management and reloaded REPL workflow
- `service-integrant` as above, using [Integrant]() for service component management and reloaded REPL workflow
- `landing-page` clojurescript single page app (SPA) using reagent and fighwheel-new
...
!!! EXAMPLE "Practicalli Makefile for Clojure projects"
    ```make title=".github/config/megalinter.yaml"
    # ------------------------------------------
